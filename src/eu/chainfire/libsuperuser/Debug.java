...
/**
 * Utility class for logging and debug features that (by default) does nothing
...
public class Debug {
	 ...
	 * 
	 * <p>
	 * By default, debug mode is enabled for development builds and disabled for
	 * exported APKs - see BuildConfig.DEBUG
	 * </p>
	 * 
	 * @param enabled
	 *            Enable debug mode ?
	 ...
	 * 
	 * <p>
	 * Current debug and enabled logtypes decide what gets logged - even if a
	 ...
	 * 
	 * <p>
	 * These messages are infrequent and mostly occur at startup/shutdown or on
	 * error
	 * </p>
	 * 
	 * @param message
	 ...
	 * 
	 * <p>
	 * This could produce a lot of output if the client runs many commands in
	 * the session
	 * </p>
	 * 
	 * @param message
	 ...
	 * 
	 * <p>
	 * You may | (or) LOG_* constants together. Note that debug mode must also
	 * be enabled for actual logging to occur.
	 * </p>
	 * 
	 * @param type
	 *            LOG_* constants
	 ...
	 * 
	 * <p>
	 * You may | (or) LOG_* constants together, to learn if <b>all</b> passed
	 * message types are enabled for logging. Note that debug mode must also be
	 * enabled for actual logging to occur.
	 * </p>
	 * 
	 * @param type
	 *            LOG_* constants
	 ...
	 * 
	 * <p>
	 * You may | (or) LOG_* constants together, to learn if <b>all</b> message
	 * types are enabled for logging. Takes debug mode into account for the
	 * result.
	 * </p>
	 * 
	 * @param type
	 ...
	 * 
	 * <p>
	 * Replaces the log method (write to logcat) with your own handler. Whether
	 * your handler gets called is still dependent on debug mode and message
	 * types being enabled for logging.
	 * </p>
	 * 
	 * @param onLogListener
	 ...
	 * 
	 * <p>
	 * Enables or disables the library crashing when su is called from the main
	 * thread.
	 * </p>
	 * 
	 * @param enabled
	 ...
	 * 
	 * <p>
	 * Note that debug mode must also be enabled for actual sanity checks to
	 * occur.
	 * </p>
	 * 
