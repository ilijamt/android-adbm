...
public class Constants {
     ...
     * Auto start on WiFi
     */
    public static final String KEY_AUTOSTART_WIFI = "auto_start_on_wifi";

    /**
     * Auto start on Ethernet key
     */
    public static final String KEY_AUTOSTART_ETH = "auto_start_on_eth";

    /**
     * Auto start on Mobile key
     */
    public static final String KEY_AUTOSTART_MOBILE = "auto_start_on_mobile";

    /**
     * Start on mobile default value
     */
    public final static boolean ADB_START_ON_MOBILE = true;

    /**
     * Start on ethernet default value
     */
    public final static boolean ADB_START_ON_ETHERNET = true;
