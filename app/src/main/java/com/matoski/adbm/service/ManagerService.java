...
public class ManagerService extends Service {
     ...
     * @param levelAndFlags    The levelAndFlags parameter specifies a wake lock level and
     *                         optional flags combined using the logical OR operator.
     * @param referenceCounted If false, it will release all the lock with one call to
     ...
     * interface
     *
     * @param message Message to send through the handler
     */
     ...
     *
     * @param update Should we show the notification or not?
     */
     ...
     *
     * @param update              Should we show the notification or not?
     * @param isNetworkADBRunning Is network ADB running or not?
     */
     ...
     *
     * @param isNetworkADBRunning Is the network ADB running
     */
     ...
     *
     * @param isNetworkADBRunning Is the ADB network running
     */
     ...
     *
     * @param isNetworkADBRunning      Is the ADB network running
     * @param dontTriggerHandlerUpdate Do not trigger {@link IMessageHandler#update(AdbStateEnum)}
     *                                 for {@link #handler}
     */
    private void showNotification(boolean isNetworkADBRunning,
    ...
    public void startNetworkADB() {
        ...
        final boolean isConnected = wifiNetworkInfo.isConnected() || ethNetworkInfo.isConnected() || mobileNetworkInfo.isConnected();
     ...
     * {@link #handler}, if {@link #handler} is set.
     *
     * @param state The current state of ADB service
     */
     ...
     * {@link #bNetworkADBStatus}
     *
     * @param isNetworkADBRunning Is network ADB running
     */
     ...
     * Update the available widgets
     *
     * @param allWidgetsIds       The widgets ID
     * @param isNetworkADBRunning Is the network ADB running
     */
